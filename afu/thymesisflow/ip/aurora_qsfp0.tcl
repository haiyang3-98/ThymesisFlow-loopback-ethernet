...
create_ip -name aurora_64b66b -vendor xilinx.com -library ip -module_name aurora_qsfp0


set_property -dict [list CONFIG.CHANNEL_ENABLE {X0Y16 X0Y17 X0Y18 X0Y19} CONFIG.C_AURORA_LANES {4} CONFIG.C_LINE_RATE {25.78125} CONFIG.C_REFCLK_FREQUENCY {161.1328125} \
